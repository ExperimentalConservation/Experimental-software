...
class TrackNClass_VizControlsWidget(QGroupBox):
    ...
    def makeVizParams(self):
        ...
        separatorV6 = QVLine()
        self.insideWidgetLayout.addWidget(separatorV6)
        self.imageParamsLayout = QVBoxLayout()
        self.insideWidgetLayout.addLayout(self.imageParamsLayout)
        ...
        # Image viz params
        self.imageParamsLayout
        self.displaynoBGVideo = QCheckBox("Display no-BG Video")
        self.displaynoBGVideo.setSizePolicy(QSizePolicy.Minimum, QSizePolicy.Minimum)
        self.displaynoBGVideo.stateChanged.connect(self.updateVizParams)
        self.imageParamsLayout.addWidget(self.displaynoBGVideo, alignment=Qt.AlignCenter|Qt.AlignTop)
    ...
    def updateVizParams(self):
        ...
        noBGFrame = self.displaynoBGVideo.isChecked()
    ...
    def resetVizParams(self, signal):
        if signal is True:
            ...
            self.displaynoBGVideo.setChecked(False)