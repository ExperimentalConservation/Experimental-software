...
from trackNClass_VideoWidget_VideoControls import TrackNClass_VideoControlsWidget
from trackNClass_VideoWidget_VideoDisplay import TrackNClass_VideoDisplayWidget
from trackNClass_VideoWidget_VizControls import TrackNClass_VizControlsWidget
from trackNClass_VideoWidget_VideoThread import TrackNClass_VideoThread
from trackNClass_ControlsWidget_VideoArenaBB import TrackNClass_VideoArenaBB
from trackNClass_ControlsWidget_VideoObjectBB import TrackNClass_VideoObjectBB

class TrackNClass_VideoWidget(QWidget):
    ...
    def makeVideoControls(self):
        self.videoControlsWidget = TrackNClass_VideoControlsWidget()
    ...
    def makeVideoDisplay(self):
        self.videoDisplayWidget = TrackNClass_VideoDisplayWidget()
    ...
    def makeVideoViz(self):
        self.vizControlsWidget = TrackNClass_VizControlsWidget()
    ...
    def loadVideo(self, videoPath):
        ...
        if self.videoPath[0] == '':
            ...
            self.videoFrame = TrackNClass_VideoThread(self.videoPath, self.videoDisplayWidget.width(), self.videoDisplayWidget.height())
    ...
    def videoDrawArena(self, drawArena):
        if drawArena is True:
            ...
            self.videoControlsWidget.videoControlsResetButton.setEnabled(False)
            self.videoControlsWidget.videoControlsFrameSlider.setEnabled(False)
            self.videoArenaBB = TrackNClass_VideoArenaBB(self.videoDisplayWidget.videoDisplayImageLabel)
    ...
    def videoDrawObjectBB(self, defineObjectBB):
        if defineObjectBB is True:
            ...
            self.videoControlsWidget.videoControlsResetButton.setEnabled(False)
            self.videoControlsWidget.videoControlsFrameSlider.setEnabled(False)
            self.videoObjectBB = TrackNClass_VideoObjectBB(self.videoDisplayWidget.videoDisplayImageLabel)
    ...
    def updateClassifierControls(self, classifierControls):
        self.videoFrame.updateClassifierControls(classifierControls)
