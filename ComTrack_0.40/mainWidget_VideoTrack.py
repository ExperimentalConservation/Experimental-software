...
from videoTrack_ControlsWidget import VideoTrack_ControlsWidget
from videoTrack_VideoWidget import VideoTrack_VideoWidget

class MainWidgetVideoTrack(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def makeControlsWidget(self):
        self.controlsWidget = VideoTrack_ControlsWidget()
        self.mainLayout.addWidget(self.controlsWidget, 0, 0, 1, 1)
        
    def makeVideoWidget(self):
        self.videoWidget = VideoTrack_VideoWidget()
