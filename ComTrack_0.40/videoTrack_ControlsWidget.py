...
from videoTrack_ControlsWidget_FileControls import VideoTrack_FileControlsWidget
from videoTrack_ControlsWidget_ArenaControls import VideoTrack_ArenaControlsWidget
from videoTrack_ControlsWidget_ImageSmoothingControls import VideoTrack_ImageSmoothingControlsWidget
from videoTrack_ControlsWidget_DetectionsControls import VideoTrack_DetectionsControlsWidget
from videoTrack_ControlsWidget_OutputControls import VideoTrack_OutputControlsWidget
from videoTrack_ControlsWidget_TrackingControls import VideoTrack_TrackingControlsWidget
from videoTrack_ControlsWidget_LoadSaveControls import VideoTrack_LoadSaveControlsWidget
from functions_ControlsAnnotator import getControlsAnnotations


class VideoTrack_ControlsWidget(QWidget):
    ...
    def makeInsideWidget(self):
        ...
        self.insideWidgetLayout.setRowStretch(5, 1)
    ...
    def makeFileControls(self):
        self.fileControlsWidget = VideoTrack_FileControlsWidget()
    ...
    def makeArenaControls(self):
        self.arenaControlsWidget = VideoTrack_ArenaControlsWidget()
    ...
    def makeLoadSaveControls(self):
        self.loadSaveControlsWidget = VideoTrack_LoadSaveControlsWidget()
    ...
    def makeImageSmoothingControls(self):
        self.imageSmoothingControlsWidget = VideoTrack_ImageSmoothingControlsWidget()
    ...
    def makeDetectionsControls(self):
        self.detectionsControlsWidget = VideoTrack_DetectionsControlsWidget()
    ...
    def makeTrackingControls(self):
        self.trackingControlsWidget = VideoTrack_TrackingControlsWidget()
    ...
    def makeOutputControls(self):
        self.outputControlsWidget = VideoTrack_OutputControlsWidget()
        self.outputControlsWidget.setEnabled(False)
        self.insideWidgetLayout.addWidget(self.outputControlsWidget, 5, 0, 1, 2)
