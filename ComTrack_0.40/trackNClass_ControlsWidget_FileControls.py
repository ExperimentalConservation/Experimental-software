...
class TrackNClass_FileControlsWidget(QGroupBox):
    ...
    def initWidget(self):
        ...
        self.setStyleSheet("""
                ...
                """)
        self.trackNClassFileControlsLayout = QVBoxLayout(self)
        self.trackNClassFileControlsLayout.setAlignment(Qt.AlignTop)  
    ...
    def makeButtons(self):
        ...
        self.trackNClassFileControlsLayout.addWidget(self.fileControlsLoadButton, alignment=Qt.AlignTop)
